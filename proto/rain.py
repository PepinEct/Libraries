...
def rain(XMOD=0, YMOD=-1, PARTICLE_CHAR="*", BACKGROUNDCHAR='#', waitTimer=0.5, PARTS=1, chance_lightning=100, lightning_maxlen=5, lightning_minlen=3):
    global grid
    ...
    while True:
        ...
        if ranNum == round(chance_lightning/2):
...
rain(XMOD=0, PARTICLE_CHAR='.', waitTimer=0.2, PARTS=3, BACKGROUNDCHAR=' ', chance_lightning=20, lightning_maxlen=12, lightning_minlen=5, YMOD=-2)